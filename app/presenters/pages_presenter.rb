class PagesPresenter
  ...
  def initialize(pages, verbs, adjectives, page, search_options, start_date, end_date)
    @pagination = PaginationPresenter.new(page: page, items_per_page: 50, total_items: pages.count)
